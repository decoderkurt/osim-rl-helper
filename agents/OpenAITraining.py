...
def train(env, nb_epochs, nb_epoch_cycles, render_eval, reward_scale, render, param_noise, actor, critic,
    ...
    tau=0.01, eval_env=None, param_noise_adaption_interval=50, restore=False, savingModelPath='./models/'):
    ...
    with U.single_threaded_session() as sess:
        #saver
        if restore == True and Path(savingModelPath + "ddpg_test_model.meta").exists():
        ...
        for epoch in range(nb_epochs):
            ...
            logger.info(rank, saver, savingModelPath)
